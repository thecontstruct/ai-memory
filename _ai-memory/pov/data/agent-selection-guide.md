...
| Phase | Primary Agents | Secondary Agents | Notes |
|---|---|---|---|
| Init | Analyst | -- | Assess current state, no implementation |
| Discovery | Analyst, PM | -- | Research first, then requirements |
| Architecture | Architect, PM | Analyst | Architect designs, PM decomposes into epics |
| Planning | SM | -- | Sprint initialization and story creation |
| Execution | DEV | Architect (if needed) | Core loop: implement, review, fix |
| Integration | DEV, Architect | QA | Full review pass + cohesion check |
| Release | SM | DEV (if fixes needed) | Retrospective + documentation |
| Maintenance | DEV | Analyst (if research needed) | Bug fix or improvement implementation |
