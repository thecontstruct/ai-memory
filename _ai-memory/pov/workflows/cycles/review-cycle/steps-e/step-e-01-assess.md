---
name: 'step-e-01-assess-cycles-review-cycle'
description: 'Edit mode: Assess review-cycle output and propose changes'
nextStepFile: './step-e-02-apply-edit.md'
---

# Edit Step 1: Assess Review Cycle Output

## STEP GOAL:

Assess the current state of review-cycle output, identify what needs to change, and propose specific edits for user approval.
...
- 🎯 Assess review-cycle output for issues identified in validation
...
- Available context: review-cycle output files, validation report (if available)
- Focus: Assessment and proposal only — no modifications
- Limits: Do not apply changes, only propose them
- Dependencies: Validation report from cycles-review-cycle validation, or user-identified issues that drive this edit

## EDIT ASSESSMENT SEQUENCE

### 1. Load Current Output

Read the review-cycle output files that need editing. If a validation report exists, load it to understand what failed.
...
**Proposed Changes for Review Cycle:**
