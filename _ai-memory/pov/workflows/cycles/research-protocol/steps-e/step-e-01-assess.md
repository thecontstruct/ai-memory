---
name: 'step-e-01-assess-cycles-research-protocol'
description: 'Edit mode: Assess research-protocol output and propose changes'
nextStepFile: './step-e-02-apply-edit.md'
---

# Edit Step 1: Assess Research Protocol Output

## STEP GOAL:

Assess the current state of research-protocol output, identify what needs to change, and propose specific edits for user approval.
...
- 🎯 Assess research-protocol output for issues identified in validation
...
- Available context: research-protocol output files, validation report (if available)
- Focus: Assessment and proposal only — no modifications
- Limits: Do not apply changes, only propose them
- Dependencies: Validation report from cycles-research-protocol validation, or user-identified issues that drive this edit

## EDIT ASSESSMENT SEQUENCE

### 1. Load Current Output

Read the research-protocol output files that need editing. If a validation report exists, load it to understand what failed.
...
**Proposed Changes for Research Protocol:**
