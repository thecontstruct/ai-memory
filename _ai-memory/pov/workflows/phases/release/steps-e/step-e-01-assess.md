---
name: 'step-e-01-assess-phases-release'
description: 'Edit mode: Assess phases-release output and propose changes'
nextStepFile: './step-e-02-apply-edit.md'
---

# Edit Step 1: Assess Phases Release Output

## STEP GOAL:

Assess the current state of phases-release output, identify what needs to change, and propose specific edits for user approval.
...
- 🎯 Assess phases-release output for issues identified in validation
...
- Available context: phases-release output files, validation report (if available)
- Focus: Assessment and proposal only — no modifications
- Limits: Do not apply changes, only propose them
- Dependencies: Validation report from phases-release validation, or user-identified issues that drive this edit

## EDIT ASSESSMENT SEQUENCE

### 1. Load Current Output

Read the phases-release output files that need editing. If a validation report exists, load it to understand what failed.
...
**Proposed Changes for Phases Release:**
