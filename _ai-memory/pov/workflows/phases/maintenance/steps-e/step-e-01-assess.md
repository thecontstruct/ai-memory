---
name: 'step-e-01-assess-phases-maintenance'
description: 'Edit mode: Assess phases-maintenance output and propose changes'
nextStepFile: './step-e-02-apply-edit.md'
---

# Edit Step 1: Assess Phases Maintenance Output

## STEP GOAL:

Assess the current state of phases-maintenance output, identify what needs to change, and propose specific edits for user approval.
...
- 🎯 Assess phases-maintenance output for issues identified in validation
...
- Available context: phases-maintenance output files, validation report (if available)
- Focus: Assessment and proposal only — no modifications
- Limits: Do not apply changes, only propose them
- Dependencies: Validation report from phases-maintenance validation, or user-identified issues that drive this edit

## EDIT ASSESSMENT SEQUENCE

### 1. Load Current Output

Read the phases-maintenance output files that need editing. If a validation report exists, load it to understand what failed.
...
**Proposed Changes for Phases Maintenance:**
