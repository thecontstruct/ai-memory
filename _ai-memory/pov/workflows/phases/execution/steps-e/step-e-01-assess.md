---
name: 'step-e-01-assess-phases-execution'
description: 'Edit mode: Assess phases-execution output and propose changes'
nextStepFile: './step-e-02-apply-edit.md'
---

# Edit Step 1: Assess Phases Execution Output

## STEP GOAL:

Assess the current state of phases-execution output, identify what needs to change, and propose specific edits for user approval.
...
- 🎯 Assess phases-execution output for issues identified in validation
...
- Available context: phases-execution output files, validation report (if available)
- Focus: Assessment and proposal only — no modifications
- Limits: Do not apply changes, only propose them
- Dependencies: Validation report from phases-execution validation, or user-identified issues that drive this edit

## EDIT ASSESSMENT SEQUENCE

### 1. Load Current Output

Read the phases-execution output files that need editing. If a validation report exists, load it to understand what failed.
...
**Proposed Changes for Phases Execution:**
