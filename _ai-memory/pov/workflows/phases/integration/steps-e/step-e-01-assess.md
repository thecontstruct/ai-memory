...
description: 'Edit mode: Assess phases-integration output and propose changes'
nextStepFile: './step-e-02-apply-edit.md'
---

# Edit Step 1: Assess Phases Integration Output

## STEP GOAL:

Assess the current state of phases-integration output, identify what needs to change, and propose specific edits for user approval.
...
- 🎯 Assess phases-integration output for issues identified in validation
...
- Available context: phases-integration output files, validation report (if available)
- Focus: Assessment and proposal only — no modifications
- Limits: Do not apply changes, only propose them
- Dependencies: Validation report from phases-integration validation, or user-identified issues that drive this edit

## EDIT ASSESSMENT SEQUENCE

### 1. Load Current Output

Read the phases-integration output files that need editing. If a validation report exists, load it to understand what failed.
...
**Proposed Changes for Phases Integration:**
