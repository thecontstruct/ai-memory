#!/usr/bin/env python3
"""Cursor IDE postToolUse(Shell) adapter — captures error patterns.

Architecture: §2 Data Flow Capture Path (error path)
PRD: FR-302 (shell error capture)

Fires when postToolUse matches Shell. Captures error patterns
...
logger = logging.getLogger("ai_memory.adapters.cursor.error_pattern_capture")
