#!/usr/bin/env python3
"""Cursor IDE postToolUse adapter — captures code patterns from file edits and MCP tools.

Architecture: §2 Data Flow Capture Path
PRD: FR-302, FR-308

Cursor postToolUse fires after Write, Edit, Read, Shell, and MCP tools.
...
logger = logging.getLogger("ai_memory.adapters.cursor.post_tool_capture")
